...
resource "aws_s3_object" "static_logo" {
  ...
  etag   = filemd5("${path.module}/../backend/static/logo.png")
}
...
resource "aws_s3_object" "static_minecraft" {
  ...
  etag   = filemd5("${path.module}/../backend/static/minecraft.mp4")
}
...
resource "aws_s3_object" "static_subway_surfers" {
  ...
  etag   = filemd5("${path.module}/../backend/static/subway_surfers.mp4")
}
