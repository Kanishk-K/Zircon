...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    h1: (props: HeadingProps) => {
        return <h1 className={`${headingFont.className} text-white font-bold text-4xl lg:text-5xl pt-12 mb-0`} {...props} />;
    },
    h2: (props: HeadingProps) => {
        return <h2 className={`${headingFont.className} text-white font-bold text-3xl lg:text-4xl mt-8 mb-3`} {...props} />;
    },
    h3 : (props: HeadingProps) => {
        return <h3 className={`${headingFont.className} text-white font-bold text-2xl lg:text-3xl mt-8 mb-3`} {...props} />;
    },
    h4 : (props: HeadingProps) => {
        return <h4 className={`${headingFont.className} text-white font-bold text-xl lg:text-2xl mt-8 mb-3`} {...props} />;
    },
    h5 : (props: HeadingProps) => {
        return <h5 className={`${headingFont.className} text-white font-bold text-lg lg:text-xl mt-8 mb-3`} {...props} />;
    },
    h6 : (props: HeadingProps) => {
        return <h6 className={`${headingFont.className} text-white font-bold text-base lg:text-lg mt-8 mb-3`} {...props} />;
    },
    p : (props) => {
