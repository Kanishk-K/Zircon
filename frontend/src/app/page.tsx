  ...
  return (
    <div className={"flex flex-col gap-16"}>
      ...
      <div className="grid grid-cols-1 mt-8 lg:grid-cols-2 lg:h-[450px] xl:h-[550px] xl:px-24 gap-16">
        <div className="relative flex flex-col lg:flex-row items-center bg-none lg:bg-card lg:border-2 lg:border-neutral-800 lg:rounded-2xl lg:p-8 lg:items-end lg:justify-center">
          <div className="flex flex-col w-full gap-4">
            <p className="text-white font-semibold text-center text-4xl lg:text-3xl lg:font-normal"><span className="text-brand">Connect</span> with most UMN Resources</p>
          </div>
        ...
        <div className="relative flex flex-col lg:flex-row items-center bg-none lg:bg-card lg:border-2 lg:border-neutral-800 lg:rounded-2xl lg:p-8 lg:items-end lg:justify-center">
          <div className="flex flex-col w-full gap-4">
            <p className="text-white font-semibold text-center text-4xl lg:text-3xl lg:font-normal"><span className="text-brand">Download</span> unlimited HD lectures</p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:h-[450px] xl:h-[550px] xl:px-24 gap-16 ">
        <div className="flex flex-col lg:flex-row items-center bg-none lg:bg-card lg:border-2 lg:border-neutral-800 lg:rounded-2xl lg:p-8 lg:justify-center">
          <div className="flex flex-col w-full gap-4 lg:w-1/2">
            <p className="text-white font-semibold text-4xl lg:text-3xl lg:font-normal"><span className="text-brand">Generate</span> a variety of short videos</p>
